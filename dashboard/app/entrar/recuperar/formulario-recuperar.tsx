  ...
  if (enviado) {
    return (
      <div className="space-y-3 text-center">
        ...
        <p className="text-sm text-slate-800">Se esse e-mail tiver conta, o link já saiu.</p>
        <p className="text-xs leading-relaxed text-slate-500">
          Verifique a caixa de entrada de <strong className="text-slate-600">{email}</strong> e
  ...
  return (
    <form onSubmit={aoEnviar} className="space-y-4">
      <label className="block">
        <span className="mb-1.5 block text-sm text-slate-600">E-mail da conta</span>
